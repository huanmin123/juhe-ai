...
try {
  ...
  const sidecarEnv = module.resolveGoSidecarEnv()
  ...
  assert.equal(sidecarEnv.JUHE_AI_RUNTIME_LOG_INSTANCE_ID, 'dev-go-sidecar-runtime-log')
  assert.equal(sidecarEnv.JUHE_AI_TABLE_MONITOR_INSTANCE_ID, 'dev-go-sidecar-table-monitor')
