...
import { downgradeGatewayAutoImageGenerationToolForPermission } from './image-permission-downgrade.js'
import {
...
import { sendInvalidJsonGatewayResponse } from './local-request-errors.js'
