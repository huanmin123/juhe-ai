...
export const DEFAULT_SYSTEM_SETTINGS = [
  ...
  ['accountQualityProbeBatchSize', 10],
  ['accountQualityProbeRepeats', 3],
  ['accountQualityProbeStaleMinutes', 10],
  ['accountQualityActiveProbeIdleHours', 24],
  ['accountQualityIgnoreStaleScoreHours', 24],
  ['accountQualityProbeModel', 'gpt-5.5'],
