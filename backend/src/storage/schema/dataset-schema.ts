...
export function applyDatasetSchema(database: DatabaseSync): void {
  database.exec(`
    ...
    CREATE TABLE IF NOT EXISTS audit_log_attempts (
          ...
          provider_code TEXT,
          attempt_model TEXT,
          attempt_upstream_model TEXT,
          attempt_pricing_model TEXT,
          attempt_model_mapping_applied INTEGER NOT NULL DEFAULT 0,
          attempt_model_mapping_source TEXT,
          attempt_source_endpoint_family TEXT,
          attempt_upstream_endpoint_family TEXT,
