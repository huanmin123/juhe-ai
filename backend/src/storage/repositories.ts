...
import {
  ...
  listRouteStrategyGroupOptionsAsync,
  listGroups,
  listGroupsAsync,
  listGroupsPage,
  listGroupsPageAsync
...
export {
  ...
  type RouteStrategyMutationVersion,
...
export {
  ...
  type SystemAccountManagementPatchOutcome,
...
export {
  ...
  type ProxyProfileManagementPatchOutcome,
  type ProxyProfileMutationResult,
  type ProxyProfileMutationValues,
