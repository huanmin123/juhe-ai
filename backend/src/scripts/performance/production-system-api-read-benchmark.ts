...
function endpointCatalog(): EndpointSpec[] {
  return [
    ...
    { name: 'GET my-usage-record detail', path: '', profile: 'broad', access: 'self', requiresAuth: true, dynamicFrom: { sourceName: 'GET my-usage-records', buildPath: (id) => `/__aisys__/api/my-usage-records/${encodeURIComponent(id)}` } },
    ...
    { name: 'GET usage-record detail', path: '', profile: 'broad', access: 'admin', requiresAuth: true, dynamicFrom: { sourceName: 'GET usage-records', buildPath: (id) => `/__aisys__/api/usage-records/${encodeURIComponent(id)}` } },
