...
function endpointCatalog(): EndpointSpec[] {
  return [
    ...
    { name: 'GET my-stats/usage-overview/summary', path: '/__aisys__/api/my-stats/usage-overview/summary', profile: 'core', access: 'self', requiresAuth: true },
    ...
    { name: 'GET stats/usage-overview/summary', path: '/__aisys__/api/stats/usage-overview/summary', profile: 'core', access: 'admin', requiresAuth: true },
    ...
    { name: 'GET stats/system-metrics/trend', path: '/__aisys__/api/stats/system-metrics/trend', profile: 'broad', access: 'admin', requiresAuth: true },
