...
assert(
  frontendAccountTestModalSource.includes('activeSingleTestTask')
    ...
    && frontendAccountTestModalSource.includes('function waitForSubmittedAccountTestResult(')
    && frontendAccountTestModalSource.includes('return waitForAccountTestResult({'),
