...
try {
  ...
  try {
    const page = repositories.listRouteStrategiesPage(access, { keyword: '检索策略', mode: 'normal', status: 'active', page: 1, pageSize: 20 })
    ...
    const wildcardResult = repositories.listRouteStrategiesPage(access, { keyword: 'route%', page: 1, pageSize: 20 })
