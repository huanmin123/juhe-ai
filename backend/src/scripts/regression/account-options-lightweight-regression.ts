  ...
  const insertAccount = databaseModule.getBusinessDatabase()
    .prepare(`
      INSERT INTO accounts (
        ...
        last_error_message, stream_failure_count, stream_failure_window_started_at, health_check_model, health_check_endpoint_family, created_at, updated_at
      ) VALUES (?, ?, 'gpt', 'profile_gpt_openai_v1', 'openai', 'v1', ?, NULL, 'api_key', 'active', 'sk-***', '{}',
        NULL, 20, 10, 0,
        0, 1, NULL, NULL, NULL, NULL,
        NULL, 0, NULL, 'gpt-5.5', 'responses', ?, ?)
    `)
  ...
  database
    .prepare(`
      INSERT INTO accounts (
        ...
        proxy_profile_id, concurrency_limit, priority, super_priority_enabled,
        fallback_enabled, schedulable, account_expires_at, last_used_at, cooldown_until, last_error_code,
        last_error_message, stream_failure_count, stream_failure_window_started_at, health_check_model, health_check_endpoint_family,
