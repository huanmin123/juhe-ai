...
try {
  ...
  assert.equal(Object.hasOwn(userDisabled, 'proxyProfileName'), false, '普通用户不可见停用代理名称')
  assert.equal(Object.hasOwn(userDisabled, 'proxyProfileType'), false, '普通用户不可见停用代理类型')
  assert.equal(Object.hasOwn(userDisabled, 'proxyProfileEnabled'), false, '普通用户不可见停用状态')
  ...
  assert.equal(Object.hasOwn(userAuthorizedDisabled, 'proxyProfileName'), false, '停用授权实例不可泄露代理名称')
  assert.equal(Object.hasOwn(userAuthorizedDisabled, 'proxyProfileType'), false, '停用授权实例不可泄露代理类型')
  assert.equal(Object.hasOwn(userAuthorizedDisabled, 'proxyProfileEnabled'), false, '停用授权实例不可泄露代理状态')
