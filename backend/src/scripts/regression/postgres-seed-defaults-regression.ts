...
assert.match(staleBuiltInModelUpdate.sql, /account_model_mappings[\s\S]*model_mapping\.provider_code[\s\S]*model_mapping\.source_model[\s\S]*model_mapping\.upstream_model/i, '仍被模型映射引用的旧目录模型不得被 seed 停用')
