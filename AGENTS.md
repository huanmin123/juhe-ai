...
- 先做轻量闭环，再扩展能力。
- 需求变化如果影响模块边界，先更新 `docs/architecture/架构总览.md` 和 `docs/plans/第一阶段计划.md`。
...
- 涉及开发环境、项目安装、本地启动、测试运行或验证流程时，先参考 `docs/develop/README.md`；安装看 `docs/develop/安装指南.md`，运行和测试看 `docs/develop/运行与验证说明.md`。
...
- 以上规范只写通用原则；具体业务范围仍以 `docs/architecture/架构总览.md`、`docs/plans/第一阶段计划.md` 和 `docs/develop/运行与验证说明.md` 为准。
