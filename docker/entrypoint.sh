...
export JUHE_AI_REDIS_STREAM_MAXLEN="${JUHE_AI_REDIS_STREAM_MAXLEN:-1000000}"
...
export JUHE_AI_AUDIT_FULL_BODY_CAPTURE_ENABLED="${JUHE_AI_AUDIT_FULL_BODY_CAPTURE_ENABLED:-false}"
