...
func ScheduledEntries() []Entry {
	return []Entry{
		...
		},
		{
			...
			GoBinding: "RecordCleanupRetryJob.RunAPIKey 已迁移；缺 dataset targets/stats 扣减 store 适配器",
		},
		{
			...
			GoStatus: GoPartial, GoPackage: "retention",
			GoBinding: "RecordCleanupRetryJob.RunAccount 已迁移；缺 store 适配器",
		},
		{
		...
		},
		{
			...
			GoBinding: "RefreshRunner 已迁移；失败前置确认需要 AccountReader/Prober/Mutation 探针适配器（gateway 持有传输层）",
		},
		{
		...
		},
		{
			...
			GoBinding: "RunBalanceAutoDetectionRecovery 已迁移；缺 BalanceDetectionRepo/LeaseRunner 业务适配器",
		},
		{
		...
		},
		{
			...
			GoStatus: GoPartial, GoPackage: "accountquality",
			GoBinding: "CooldownRetestRunner 已迁移；缺 Prober/CooldownCandidateSource/Mutation 适配器",
		},
		{
			...
			GoStatus: GoPartial, GoPackage: "opsjobs",
			GoBinding: "SpeedFirstProbeRunner 已迁移；缺 SpeedFirstClaimStore/CandidateSource 适配器",
		},
		{
			...
			GoStatus: GoPartial, GoPackage: "opsjobs",
			GoBinding: "ControlPlaneMaintenance 已迁移；缺 ControlPlaneLedger/Outbox/Redis CircuitStore 适配器",
		},
		{
			...
			GoStatus: GoPartial, GoPackage: "opsjobs",
			GoBinding: "RunListAvailabilityMaintenance 已迁移；缺 ListAvailabilityRepo（PG 读模型）适配器",
		},
		{
			...
			GoStatus: GoPartial, GoPackage: "opsjobs",
			GoBinding: "CircuitRecoveryService 已迁移；缺 Redis CircuitStore 与目标解析适配器",
		},
		{
		...
		},
		{
			...
			GoStatus: GoPartial, GoPackage: "retention",
			GoBinding: "DataRetentionJob 已迁移；缺 StatsWriter/PublicApiLogsCleaner/UsageRecordsCleaner/DbService 适配器",
		},
		{
			...
			Writes:   []string{"chat:*"},
			GoStatus: GoPartial, GoPackage: "retention",
			GoBinding: "ChatRetentionJob 已迁移；缺 chat DbService 适配器",
		},
		{
			...
			GoStatus: GoPartial, GoPackage: "retention",
			GoBinding: "ExpiredDeletedAccountJob 已迁移；缺 DbService/RecordMaintenanceEnqueuer 适配器",
		},
	}
}
