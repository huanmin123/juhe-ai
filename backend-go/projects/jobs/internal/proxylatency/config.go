...
func LoadRuntimeConfig(getenv func(string) string) (RuntimeConfig, error) {
	...
	if cfg.InputLimit, err = runtimeInt(getenv, "JUHE_AI_PROXY_LATENCY_INPUT_LIMIT", defaultProxyLatencyProbeLimit, 1, 5096); err != nil {
		return RuntimeConfig{}, err
	}
	if cfg.BatchSize, err = runtimeInt(getenv, "JUHE_AI_PROXY_LATENCY_BATCH_SIZE", defaultProxyLatencyBatchSize, 1, 5096); err != nil {
		return RuntimeConfig{}, err
	}
	...
	if cfg.WorkerConcurrency, err = runtimeInt(getenv, "JUHE_AI_PROXY_LATENCY_WORKER_CONCURRENCY", defaultProxyLatencyConcurrency, 1, 5096); err != nil {
		return RuntimeConfig{}, err
	}
