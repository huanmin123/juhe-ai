...
// 基础设施小文件的补充覆盖测试（bridge 域半边，自 cov_infra_test.go 拆出）：
// JSON/SSE 助手、HTTP 查询解析、时间工具、hosted tool 注册表、computer
// adapter 归一化、config 投影与 SSE pump（storage 半边见 openaicompatstorage）。
