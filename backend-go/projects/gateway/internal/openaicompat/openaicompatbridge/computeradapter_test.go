...
// jsonResponse mirrors the storage-domain test helper of the same name in
// imagegeneration_test.go (copied, not imported, to keep the test packages
// decoupled).
...
// mockTransport mirrors the storage-domain test helper of the same name in
// imagegeneration_test.go (copied, not imported, to keep the test packages
// decoupled); it satisfies the package-local HTTPDoer port.
...
// decodeJSON mirrors the storage-domain test helper of the same name in
// testdata_test.go (copied, not imported, to keep the test packages decoupled).
