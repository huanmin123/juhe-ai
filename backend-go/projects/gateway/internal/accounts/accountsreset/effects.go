...
// effectsOrNil resolves the wired port for the reset paths (装配断线时保持
// 端点自含：返回 nil 让 runtime 清理报 unchanged/zero).
func (s *Service) effectsOrNil() RuntimeResetEffects {
	if s.effects == nil {
