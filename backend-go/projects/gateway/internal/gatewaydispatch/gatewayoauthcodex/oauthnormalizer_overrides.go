...
func ResolveGptRequestOverrideModelCapabilities(ctx context.Context, account gatewayruntimecache.OpenAIAccountSecret, upstreamModel string) (*GptRequestOverrideModelCapabilities, error) {
