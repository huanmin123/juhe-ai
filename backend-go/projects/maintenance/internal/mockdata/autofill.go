...
var autofillSkipExactTables = map[string]string{
	...
	"usage_record_cleanup_deductions":          "域业务表：seedStatsRaw 写入统计扣减",
	...
	"account_health_outcomes":                  "域业务表：seedChatCodexModelCheck 写入探针结果",
	"account_health_direct_input_suppressions": "域业务表：seedChatCodexModelCheck 写入直连输入抑制",
	"account_health_jobs_input_versions":       "域业务表：seedChatCodexModelCheck 写入输入版本",
	"account_health_jobs_input_outbox":         "域业务表：seedChatCodexModelCheck 写入输入 outbox",
