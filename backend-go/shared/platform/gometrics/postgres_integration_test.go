...
// Postgres smoke migrated from the former jobs gometricsstore suite: opt-in
// via JUHE_AI_GO_RUNTIME_METRICS_POSTGRES_SMOKE_URL, skipped when unset.
...
func TestPostgresStoreSmoke(t *testing.T) {
	...
	sample := RuntimeSnapshot{SampledAt: when, ProcessPID: 987654, Service: service, Role: "jobs", Goroutines: 3, HeapAllocBytes: 10, HeapLiveBytes: 9, HeapObjects: 2, Threads: 1}
