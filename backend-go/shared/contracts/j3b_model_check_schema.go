...
var J3BModelCheckIndexes = map[string]string{
	...
	"idx_model_check_runs_created":                     "on juhe_j3b.model_check_runs using btree (created_at desc, id desc)",
	...
	"idx_model_account_trust_results_updated":          "on juhe_j3b.model_account_trust_results using btree (updated_at, account_id, requested_model)",
	"idx_model_trust_latest_dirty_updated":             "on juhe_j3b.model_trust_latest_dirty_accounts using btree (updated_at, system_account_id, account_id, requested_model)",
	"idx_model_trust_observation_receipts_processed":   "on juhe_j3b.model_trust_observation_receipts using btree (processed_at, observation_id)",
}
...
var J3BModelCheckColumns = map[string]map[string]PostgresColumnSpec{
	...
	"model_check_observations": {
		"id": {DataType: "text", UdtName: "text"}, "run_id": {DataType: "text", UdtName: "text"}, "system_account_id": {DataType: "text", UdtName: "text"}, "account_id": {DataType: "text", UdtName: "text"}, "provider_code": {DataType: "text", UdtName: "text"}, "provider_protocol_profile_id": {DataType: "text", UdtName: "text"}, "endpoint_family": {DataType: "text", UdtName: "text"}, "requested_model": {DataType: "text", UdtName: "text"}, "mapped_upstream_model": {DataType: "text", UdtName: "text"}, "observed_model": {DataType: "text", UdtName: "text", Nullable: true}, "mapping_applied": {DataType: "integer", UdtName: "int4"}, "upstream_bucket_hmac": {DataType: "text", UdtName: "text"}, "cohort_key_hmac": {DataType: "text", UdtName: "text"}, "population_key_hmac": {DataType: "text", UdtName: "text"}, "probe_key_hmac": {DataType: "text", UdtName: "text"}, "system_fingerprint_hmac": {DataType: "text", UdtName: "text", Nullable: true}, "probe_family": {DataType: "text", UdtName: "text"}, "probe_set_version": {DataType: "text", UdtName: "text"}, "tokenizer_version": {DataType: "text", UdtName: "text"}, "feature_version": {DataType: "text", UdtName: "text"}, "round_index": {DataType: "integer", UdtName: "int4"}, "padding_tokens": {DataType: "integer", UdtName: "int4"}, "local_input_tokens": {DataType: "integer", UdtName: "int4"}, "reported_input_tokens": {DataType: "integer", UdtName: "int4", Nullable: true}, "cached_input_tokens": {DataType: "integer", UdtName: "int4", Nullable: true}, "constraint_passed": {DataType: "integer", UdtName: "int4", Nullable: true}, "feature_1": {DataType: "double precision", UdtName: "float8", Nullable: true}, "feature_2": {DataType: "double precision", UdtName: "float8", Nullable: true}, "feature_3": {DataType: "double precision", UdtName: "float8", Nullable: true}, "feature_4": {DataType: "double precision", UdtName: "float8", Nullable: true}, "feature_5": {DataType: "double precision", UdtName: "float8", Nullable: true}, "feature_6": {DataType: "double precision", UdtName: "float8", Nullable: true}, "feature_7": {DataType: "double precision", UdtName: "float8", Nullable: true}, "feature_8": {DataType: "double precision", UdtName: "float8", Nullable: true}, "observation_status": {DataType: "text", UdtName: "text"}, "identity_status": {DataType: "text", UdtName: "text"}, "mapping_status": {DataType: "text", UdtName: "text"}, "protocol_status": {DataType: "text", UdtName: "text"}, "evidence_coverage": {DataType: "integer", UdtName: "int4"}, "trace_id": {DataType: "text", UdtName: "text", Nullable: true}, "created_at": {DataType: "text", UdtName: "text"}, "aggregation_completed_at": {DataType: "text", UdtName: "text", Nullable: true},
	},
	"account_quality_health_hourly": {
	...
	"model_check_scheduler_tasks": {
		"id": {DataType: "text", UdtName: "text"}, "kind": {DataType: "text", UdtName: "text"}, "due_at": {DataType: "timestamp with time zone", UdtName: "timestamptz"}, "claim_owner": {DataType: "text", UdtName: "text", Nullable: true}, "claim_until": {DataType: "timestamp with time zone", UdtName: "timestamptz", Nullable: true}, "fence_token": {DataType: "bigint", UdtName: "int8"}, "state": {DataType: "text", UdtName: "text"}, "last_error": {DataType: "text", UdtName: "text", Nullable: true}, "completed_at": {DataType: "timestamp with time zone", UdtName: "timestamptz", Nullable: true}, "payload": {DataType: "jsonb", UdtName: "jsonb"}, "updated_at": {DataType: "timestamp with time zone", UdtName: "timestamptz"},
	},
	"model_token_intercept_baseline_versions": {
	...
	"model_account_trust_results": {
		"system_account_id": {DataType: "text", UdtName: "text"}, "account_id": {DataType: "text", UdtName: "text"}, "requested_model": {DataType: "text", UdtName: "text"}, "identity_status": {DataType: "text", UdtName: "text"}, "mapping_status": {DataType: "text", UdtName: "text"}, "usage_integrity_status": {DataType: "text", UdtName: "text"}, "protocol_status": {DataType: "text", UdtName: "text"}, "evidence_status": {DataType: "text", UdtName: "text"}, "evidence_coverage": {DataType: "integer", UdtName: "int4"}, "observation_count": {DataType: "integer", UdtName: "int4"}, "round_count": {DataType: "integer", UdtName: "int4"}, "independent_source_count": {DataType: "integer", UdtName: "int4"}, "identity_observation_count": {DataType: "integer", UdtName: "int4"}, "paired_probe_count": {DataType: "integer", UdtName: "int4"}, "slope": {DataType: "double precision", UdtName: "float8", Nullable: true}, "intercept": {DataType: "double precision", UdtName: "float8", Nullable: true}, "intercept_baseline_median": {DataType: "double precision", UdtName: "float8", Nullable: true}, "intercept_baseline_mad": {DataType: "double precision", UdtName: "float8", Nullable: true}, "intercept_baseline_version": {DataType: "integer", UdtName: "int4", Nullable: true}, "intercept_baseline_status": {DataType: "text", UdtName: "text", Nullable: true}, "intercept_strong_gate_enabled": {DataType: "integer", UdtName: "int4"}, "identity_distance": {DataType: "double precision", UdtName: "float8", Nullable: true}, "paired_distance": {DataType: "double precision", UdtName: "float8", Nullable: true}, "paired_baseline_median": {DataType: "double precision", UdtName: "float8", Nullable: true}, "paired_baseline_mad": {DataType: "double precision", UdtName: "float8", Nullable: true}, "baseline_version": {DataType: "integer", UdtName: "int4", Nullable: true}, "baseline_version_status": {DataType: "text", UdtName: "text", Nullable: true}, "feature_version": {DataType: "text", UdtName: "text", Nullable: true}, "tokenizer_version": {DataType: "text", UdtName: "text", Nullable: true}, "probe_set_version": {DataType: "text", UdtName: "text", Nullable: true}, "reason_codes_json": {DataType: "text", UdtName: "text"}, "last_observed_id": {DataType: "text", UdtName: "text", Nullable: true}, "last_observed_at": {DataType: "text", UdtName: "text", Nullable: true}, "updated_at": {DataType: "text", UdtName: "text"},
	},
	"model_trust_latest_dirty_accounts": {
		"system_account_id": {DataType: "text", UdtName: "text"}, "account_id": {DataType: "text", UdtName: "text"}, "requested_model": {DataType: "text", UdtName: "text"}, "dirty_reason": {DataType: "text", UdtName: "text"}, "updated_at": {DataType: "text", UdtName: "text"},
	},
	"model_trust_observation_receipts": {
		"observation_id": {DataType: "text", UdtName: "text"}, "observation_created_at": {DataType: "text", UdtName: "text"}, "processed_at": {DataType: "text", UdtName: "text"},
	},
	"model_trust_aggregation_state": {
		"scope_key": {DataType: "text", UdtName: "text"}, "cursor_created_at": {DataType: "text", UdtName: "text", Nullable: true}, "cursor_id": {DataType: "text", UdtName: "text", Nullable: true}, "last_success_at": {DataType: "text", UdtName: "text", Nullable: true}, "last_error_message": {DataType: "text", UdtName: "text", Nullable: true}, "lag_seconds": {DataType: "integer", UdtName: "int4", Nullable: true}, "updated_at": {DataType: "text", UdtName: "text"},
	},
}
...
var J3BModelCheckConstraints = map[string][]string{
	...
	"model_account_trust_results":             {"primary key (system_account_id, account_id, requested_model)"},
	"model_trust_latest_dirty_accounts":       {"primary key (system_account_id, account_id, requested_model)"},
	"model_trust_observation_receipts":        {"primary key (observation_id)"},
	"model_trust_aggregation_state":           {"primary key (scope_key)"},
}
