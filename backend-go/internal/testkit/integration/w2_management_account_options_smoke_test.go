	...
	for index, item := range fixtures {
		_, err := db.ExecContext(ctx, `
			INSERT INTO juhe_business.accounts (
				...
				super_priority_enabled, fallback_enabled, client_compatibility, schedulable, health_check_model, health_check_endpoint_mode,
				cooldown_until, created_at, updated_at
			) VALUES (
				$1, $2, $3, $4,
				$5, $6, $7, 'api_key', $8, 'encrypted-fixture',
				NULL, 'sk-test', 20, $9,
				false, false, 'openai_standard', $10, 'gpt-5.6-sol', 'chat_json',
				$11, $12, $13
			)
	...
	for index, item := range fixtures {
		_, err = db.ExecContext(ctx, `
			INSERT INTO juhe_business.accounts (
				...
				NULL, 'sk-test', 20, $3,
				false, false, 'openai_standard', true, 'gpt-5.6-sol', 'chat_json',
