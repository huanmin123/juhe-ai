...
func insertW5ManagementGroupDetailFixtures(
	...
	if _, err := db.ExecContext(ctx, `
		INSERT INTO juhe_business.accounts (
			...
			($1, $5, 'openai', 'profile_openai_openai_v1', 'openai', 'v1', $1, 'api_key', 'active', 'v1:test:test:1', 'sk***1', 20, 0, 'openai_standard', true, 'gpt-5.6-sol', $6, $6),
			($2, $5, 'openai', 'profile_openai_openai_v1', 'openai', 'v1', $2, 'api_key', 'active', 'v1:test:test:2', 'sk***2', 20, 0, 'openai_standard', true, 'gpt-5.6-sol', $7, $7),
			($3, $5, 'openai', 'profile_openai_openai_v1', 'openai', 'v1', $3, 'api_key', 'active', 'v1:test:test:3', 'sk***3', 20, 0, 'openai_standard', true, 'gpt-5.6-sol', $8, $8),
			($4, $5, 'openai', 'profile_openai_openai_v1', 'openai', 'v1', $4, 'api_key', 'active', 'v1:test:test:4', 'sk***4', 20, 0, 'openai_standard', true, 'gpt-5.6-sol', $9, $9)
	`,
		w5ManagementGroupDetailOwnedAccount1,
		w5ManagementGroupDetailOwnedAccount2,
