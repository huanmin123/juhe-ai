...
ORDER BY
  ...
  CASE WHEN sqlc.arg(sort_field)::text = 'errorRate' AND sqlc.arg(sort_order)::text = 'asc' THEN CASE WHEN range_stats.request_count > 0 THEN range_stats.error_count::double precision / range_stats.request_count ELSE 0::double precision END END ASC,
  CASE WHEN sqlc.arg(sort_field)::text = 'errorRate' AND sqlc.arg(sort_order)::text = 'desc' THEN CASE WHEN range_stats.request_count > 0 THEN range_stats.error_count::double precision / range_stats.request_count ELSE 0::double precision END END DESC,
