...
SET status = sqlc.arg(status), catalog_visible = sqlc.arg(catalog_visible), mode = sqlc.narg(mode),
    ...
    cache_storage_usd_per_1m_per_hour = sqlc.narg(cache_storage_usd_per_1m_per_hour),
...
INSERT INTO juhe_business.custom_provider_models (
  ...
  sqlc.narg(input_usd_per_1m), sqlc.narg(output_usd_per_1m), sqlc.narg(cached_input_usd_per_1m), sqlc.narg(cache_write_usd_per_1m), sqlc.narg(cache_write_1h_usd_per_1m), sqlc.narg(cache_storage_usd_per_1m_per_hour), sqlc.arg(service_tier_prices_json),
