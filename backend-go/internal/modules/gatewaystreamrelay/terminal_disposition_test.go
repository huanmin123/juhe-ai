...
func TestDecideTerminalDisposition(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "downstream close never signals", input: TerminalDispositionInput{Commit: committed, TerminalKind: TerminalKindDownstreamClosed, Capability: CommittedFailureSignalProtocolEvent}, want: TerminalDisposition{TerminalKind: TerminalKindDownstreamClosed, Disconnect: true}},
