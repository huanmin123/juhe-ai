...
func TestResolveRequestLane(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "bare nano banana model", request: RequestShape{Path: "/v1/responses", Model: "nano-banana"}, want: RequestLaneImage},
		{name: "Gemini image model", request: RequestShape{Path: "/v1/responses", Model: "gemini-2.5-flash-image"}, want: RequestLaneImage},
		{name: "Gemini image preview model", request: RequestShape{Path: "/v1/responses", Model: "gemini-3-pro-image-preview"}, want: RequestLaneImage},
