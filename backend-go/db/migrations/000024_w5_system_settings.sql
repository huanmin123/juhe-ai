...
VALUES
  ...
  ('sys_admin', 'textFirstResponseTimeoutSeconds', '120', now()),
  ('sys_admin', 'textStreamIdleTimeoutSeconds', '30', now()),
  ('sys_admin', 'textUncommittedAttemptMaxLifetimeSeconds', '1800', now()),
  ('sys_admin', 'imageFirstResponseTimeoutSeconds', '600', now()),
  ('sys_admin', 'imageStreamIdleTimeoutSeconds', '120', now()),
  ('sys_admin', 'imageUncommittedAttemptMaxLifetimeSeconds', '3600', now()),
  ('sys_admin', 'noAvailableAccountWaitTimeoutSeconds', '270', now()),
