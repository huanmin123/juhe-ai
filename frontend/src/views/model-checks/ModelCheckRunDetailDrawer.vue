    ...
    <div v-else class="run-detail">
      <div class="run-detail-head">
        ...
        <a-space wrap>
          ...
          <a-tag :color="modelCheckProfileColor(run.profile)">{{ modelCheckProfileText(run.profile) }}</a-tag>
      ...
      <a-descriptions bordered size="small" :column="descriptionColumns" class="run-descriptions">
        ...
        <a-descriptions-item label="检测模式">{{ modelCheckProfileText(run.profile) }}</a-descriptions-item>
