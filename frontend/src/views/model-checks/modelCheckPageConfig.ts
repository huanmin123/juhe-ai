...
export const modelCheckFallbackOptions: ModelCheckOptions = {
  ...
  supportedProfiles: [
    { value: 'quick', label: '快速检测', description: '最多 2 个单轮轻量探针，适合初步筛查' },
    { value: 'full', label: '深度检测', description: '完整强诊断探针，耗时与额度消耗更高' }
  ],
  trustedComparison: { enabledByDefault: false, available: true, message: '可信对比仅在深度检测中可用；选择可信账户后会额外消耗该账户额度。' },
