...
export const runtimeLogEventTextMap: Record<string, string> = {
  ...
  background_cooldown_account_retest_completed: '后台冷却账户复测已入队',
  background_cooldown_account_retest_discarded: '后台冷却账户复测已跳过',
  background_cooldown_account_retest_failed: '后台冷却账户复测失败',
  background_cooldown_account_retest_restored: '后台冷却账户复测恢复成功',
  background_cooldown_account_retest_retry_exhausted: '后台冷却账户复测重试用尽',
  background_cooldown_account_retest_retry_scheduled: '后台冷却账户复测重试已调度',
  ...
  'db_service.request.start': 'DB Service 请求开始',
  'db_service.request.complete': 'DB Service 请求完成',
  'db_service.request.failed': 'DB Service 请求失败',
  ...
  gateway_account_local_half_open_acquired: '网关账户半开探测已放行',
  gateway_account_local_suppressed: '网关本地抑制账户',
  gateway_account_local_suppression_precheck_required: '网关本地避让升级事前确认',
  ...
  gateway_non_stream_body_interrupted_after_output: '网关非流式响应正文中断',
  gateway_non_stream_response_capture_truncated: '网关非流式响应截断记录',
  gateway_non_stream_response_inspection_omitted: '网关非流式响应检查已省略',
  ...
  gateway_response_inspected: '网关响应检查已命中',
  gateway_response_inspected_after_downstream_write: '网关响应检查已命中但下游已写入',
  gateway_response_inspected_before_downstream_commit: '网关响应检查已在下游提交前命中',
  gateway_response_inspected_before_downstream_write: '网关响应检查已在写入下游前命中',
  gateway_response_inspection_parser_skipped: '网关响应检查解析已跳过',
  ...
  'gateway.request.failure': '网关请求阶段失败',
  'gateway.request.stage': '网关请求阶段',
  'gateway.request.timing_summary': '网关请求耗时汇总',
  http_request_closed: 'HTTP 请求连接关闭',
  http_request_closed_after_protocol_terminal: 'HTTP 协议终止后连接关闭',
