...
import { useLoginBrandPanelOrbitAnimations } from './useLoginBrandPanelOrbitAnimations'
...
const { showcaseRef } = useLoginBrandPanelOrbitAnimations()
</script>

<style scoped src="./LoginBrandPanel.css"></style>
