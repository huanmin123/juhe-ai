...
import { ANTHROPIC_PROVIDER_CODE, DEEPSEEK_PROVIDER_CODE, GEMINI_PROVIDER_CODE, GLM_PROVIDER_CODE, GPT_VENDOR_CODE, HYBRID_PROVIDER_CODE, OPENAI_COMPATIBLE_PROVIDER_CODE, XAI_PROVIDER_CODE, normalizeProviderToken } from './providerProtocol'

const builtinProviderNames = new Map<string, string>([
  [OPENAI_COMPATIBLE_PROVIDER_CODE, 'OpenAI 兼容'],
  [GPT_VENDOR_CODE, 'GPT'],
  [XAI_PROVIDER_CODE, 'xAI / Grok'],
