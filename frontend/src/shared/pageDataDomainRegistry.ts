...
export const pageDataDomainRegistry = [
  ...
  spec('accounts.options', 'P0', ['/my-accounts', '/accounts', '/my-groups', '/groups', '/my-authorizations', '/authorizations'], ['/my-accounts/options', '/accounts/options'], ['self', 'admin-target'], 'durable', 30_000, false, 'active', ['account-write', 'account-import', 'account-runtime', 'account-expiry', 'account-availability-schedule', 'account-authorization']),
  ...
  spec('stats.overview', 'P0', ['/my-stats', '/stats'], ['/my-stats/usage-overview', '/stats/usage-overview'], ['self', 'admin-target', 'admin-global'], 'durable', 60_000, false, 'active', ['stats-window-commit', 'stats-rebuild', 'usage-timezone', 'account-write', 'authorization-write', 'team-member-write']),
  spec('groups.static', 'P1', ['/my-groups', '/groups'], ['/my-groups', '/groups', '/my-groups/options', '/groups/options'], ['self', 'admin-target'], 'durable', 30_000, false, 'active', ['group-write', 'group-account-binding', 'group-authorization', 'team-member-write']),
  ...
  spec('routeStrategies.options', 'P1', ['/my-api-keys', '/api-keys', '/my-route-strategies', '/route-strategies'], ['/my-route-strategies/options', '/route-strategies/options'], ['self', 'admin-target'], 'durable', 30_000, false, 'active', ['route-strategy-write', 'group-write']),
  spec('providers.catalog', 'P1', ['/my-models', '/providers'], ['/providers/options', '/providers/models/options', '/providers/:code/models'], ['self', 'admin-target', 'admin-global'], 'durable', 300_000, false, 'active', ['provider-write', 'provider-model-write', 'model-pricing-write']),
  ...
  spec('teams.options', 'P1', ['/my-teams', '/authorization-teams', '/my-authorizations', '/authorizations'], ['/my-authorization-options/grantee-teams', '/authorization-options/grantee-teams'], ['self', 'admin-global'], 'durable', 30_000, false, 'active', ['team-write', 'team-member-write', 'authorization-write']),
  spec('stats.accountUsage', 'P1', ['/my-usage-stats', '/usage-stats'], ['/my-stats/account-usage', '/stats/account-usage'], ['self', 'admin-target'], 'durable', 60_000, false, 'active', ['stats-window-commit', 'stats-rebuild', 'account-write', 'authorization-write', 'team-member-write']),
  spec('stats.aiPerformance', 'P1', ['/my-ai-performance', '/ai-performance'], ['/my-stats/ai-performance', '/stats/ai-performance'], ['self', 'admin-target'], 'durable', 60_000, false, 'active', ['stats-window-commit', 'account-write', 'authorization-write', 'team-member-write']),
  ...
  spec('systemAccounts.options', 'P1', ['/system-accounts', '/accounts', '/groups', '/authorizations'], ['/system-accounts/options', '/authorization-options/grantee-accounts'], ['admin-global'], 'durable', 30_000, false, 'active', ['system-account-write', 'profile-write', 'authorization-write']),
