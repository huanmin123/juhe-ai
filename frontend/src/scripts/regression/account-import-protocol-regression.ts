...
assertMatch(accountImportProtocolMarkdown, /`modelMappings` 右侧 `upstreamEndpointFamily: "responses"` 只允许原生 Responses 直连/, '协议 Markdown 应说明右侧 Responses 只允许原生直连')
...
assertMatch(formalProtocolMarkdown, /`modelMappings` 右侧 `upstreamEndpointFamily: "responses"` 只允许原生 Responses 直连/, '正式协议文档应说明右侧 Responses 只允许原生直连')
