...
assertMatch(accountImportProtocolMarkdown, /`modelMappings` 右侧 `upstreamEndpointFamily: "responses"` 只允许账号真实支持 Responses API 的 OpenAI\/GPT 原生上游/, '协议 Markdown 应说明右侧 Responses 只允许真实 Responses 上游')
...
assertMatch(formalProtocolMarkdown, /`modelMappings` 右侧 `upstreamEndpointFamily: "responses"` 只允许账号真实支持 Responses API 的 OpenAI\/GPT 原生上游/, '正式协议文档应说明右侧 Responses 只允许真实 Responses 上游')
