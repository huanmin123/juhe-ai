...
import { replaceEditorDocumentWithoutHistory } from '../../views/chat/composer/chatEditorDocumentBoundary'
...
replaceEditorDocumentWithoutHistory(editorBoundary, { type: 'doc', content: [{ type: 'paragraph', content: [{ type: 'text', text: '最近消息 Markdown' }] }] })
