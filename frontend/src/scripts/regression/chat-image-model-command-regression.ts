...
assert.match(types, /type ChatImageModel\s*=\s*'gpt-image-2'\s*\|\s*'grok-imagine-image'\s*\|\s*'grok-imagine-image-quality'/)
...
assert.match(view, /'grok-imagine-image'/)
assert.match(view, /'grok-imagine-image-quality'/)
