...
const basicInfoSource = readFileSync('../frontend/src/views/accounts/AccountBasicInfoSection.vue', 'utf8')
...
assert.doesNotMatch(basicInfoSource, /<a-radio value="active">可调度<\/a-radio>/, '新建账户不得绕过首次健康检查直接选择可调度')
