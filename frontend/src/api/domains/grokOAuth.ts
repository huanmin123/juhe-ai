...
export const grokOAuthApi = {
  ...
  createFromCode: (payload: Record<string, unknown>, params?: ListParams) => unwrap<AccountSummary>(http.post('/grok-oauth/create-from-code', payload, { params })),
  createFromRefreshToken: (payload: Record<string, unknown>, params?: ListParams) => unwrap<AccountSummary>(http.post('/grok-oauth/create-from-refresh-token', payload, { params })),
...
export const myGrokOAuthApi = {
  ...
  createFromCode: (payload: Record<string, unknown>) => unwrap<AccountSummary>(http.post('/my-grok-oauth/create-from-code', payload)),
  createFromRefreshToken: (payload: Record<string, unknown>) => unwrap<AccountSummary>(http.post('/my-grok-oauth/create-from-refresh-token', payload)),
