...
export const anthropicOAuthApi = {
  ...
  refreshToken: (id: string, payload: OAuthCredentialRotationPayload, params?: ListParams) => unwrap<OAuthCredentialRotationResult>(http.post(`/anthropic-oauth/accounts/${id}/refresh-token`, payload, { params, timeout: 130000 })),
...
export const myAnthropicOAuthApi = {
  ...
  refreshToken: (id: string, payload: OAuthCredentialRotationPayload) => unwrap<OAuthCredentialRotationResult>(http.post(`/my-anthropic-oauth/accounts/${id}/refresh-token`, payload, { timeout: 130000 })),
