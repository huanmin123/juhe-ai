...
export const accountsApi = {
  ...
  balanceDetails: (id: string, params?: ListParams) => unwrap<AccountBalanceDetails>(http.get(`/accounts/${id}/balance/details`, { params })),
...
export const myAccountsApi = {
  ...
  balanceDetails: (id: string) => unwrap<AccountBalanceDetails>(http.get(`/my-accounts/${id}/balance/details`)),
