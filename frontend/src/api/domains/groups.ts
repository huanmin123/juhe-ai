import type { AccountGroupOptionSummary, GroupEditDetail, GroupListResult, GroupMutationResult, GroupOptionSummary, GroupSummary, RouteStrategyGroupOption } from '@/types/domain'
