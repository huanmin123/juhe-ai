...
export const providersApi = {
  ...
  setDefaultTestModel: async (code: string, model: string) => {
    const result = await unwrap<ProviderDefaultTestModelResult>(http.put(`/providers/${code}/default-test-model`, { model }))
