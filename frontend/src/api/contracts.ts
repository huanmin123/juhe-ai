...
export interface AccountDraftTestAccountPayload {
  ...
  modelMappings: Array<{ sourceModel: string; sourceEndpointFamily: 'chat_completions' | 'responses'; upstreamModel: string; upstreamEndpointFamily: 'chat_completions' | 'responses' | 'messages'; enabled: boolean }>
