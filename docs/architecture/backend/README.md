...
- 页面数据：通用 `PageDataChangeStore`、confirm/revision、Redis publisher 和 dirty-domain recovery 已由 PLAN-0156 删除。页面直接调用业务接口；repository/shared cache 与独立业务快照按各自功能维护。
