...
| AI 问答 | 登录用户使用自己 API Key 的平台内置 OpenAI 客户端；维护会话、最近 7 天完整轮次、站内 SSE、原生工具投影和富文本展示，聊天正文使用独立 SQLite / `juhe_chat` schema，所有模型请求仍按普通客户端进入现有网关 | [AI 问答设计](../functions/AI问答设计.md) |
