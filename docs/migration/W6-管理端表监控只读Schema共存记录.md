...
`000070_w2_gateway_model_catalog_chat_snapshot_variants.sql` 与 `000071_w2_gpt_codex_auto_review_default.sql` 已正式发布；page-data 退场随后新增 `000072_w7_drop_page_data_dirty_domains.sql`，权威 Goose catalog 当前连续到 `000072`。本表监控切片没有新增 migration；后续工作必须从真实 catalog 派生下一连续版本，不能复用或改写已发布版本。
