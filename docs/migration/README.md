...
> **当前状态（2026-08-12）。** F1/F2/F3 已进入正式 Mac 拓扑，F3 生产读回已验证；首次上线发生过硬停机和前端 API-base 构建事故，发布零停机流程尚未证明。先完成独立 candidate/handover 演练，再进入 F4 操作日志。旧 [2026-08-10 状态](迁移状态与后续批次-20260810.md) 仅作历史快照。
