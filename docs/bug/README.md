...
| 编号 | 标题 | 状态 | 严重程度 | 模块 | 文档 |
| --- | --- | --- | --- | --- | --- |
| BUG-0063 | 弹窗余额验证意外保存配置和快照 | 已修复（待上线验证） | P1 | 前端 / 后端 / AI 账户 / 余额查询 / API 契约 | [问题-0063-弹窗余额验证意外保存配置和快照.md](问题-0063-弹窗余额验证意外保存配置和快照.md) |
| BUG-0062 | 余额刷新后列表金额不立即更新 | 已修复（待上线验证） | P2 | 前端 / Vue / AI 账户 / 余额查询 | [问题-0062-余额刷新后列表金额不立即更新.md](问题-0062-余额刷新后列表金额不立即更新.md) |
