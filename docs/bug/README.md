...
| 编号 | 标题 | 状态 | 严重程度 | 模块 | 文档 |
| --- | --- | --- | --- | --- | --- |
| BUG-0088 | AI 问答长会话初始停在最早消息 | 已修复（浏览器验证） | P2 | 前端 / AI 问答 / 长会话 / 虚拟列表 / 滚动 | [问题-0088-AI问答长会话初始停在最早消息.md](问题-0088-AI问答长会话初始停在最早消息.md) |
| BUG-0087 | AI 问答上下文恢复边界断链 | 已修复（Mock、repository 与真实模型验证） | P1 | 后端 / AI 问答 / 上下文 / 主动压缩 / 图片记忆 | [问题-0087-AI问答上下文恢复边界断链.md](问题-0087-AI问答上下文恢复边界断链.md) |
| BUG-0086 | AI 问答默认文本块为空导致模型历史丢字 | 已修复（repository 与压缩回归） | P1 | 后端 / AI 问答 / 内容块 / 上下文 | [问题-0086-AI问答默认文本块为空导致模型历史丢字.md](问题-0086-AI问答默认文本块为空导致模型历史丢字.md) |
| BUG-0085 | AI 问答上游响应伪有界读取 | 已修复（回归验证） | P1 | 后端 / AI 问答 / SSE / JSON / 内存边界 | [问题-0085-AI问答上游响应伪有界读取.md](问题-0085-AI问答上游响应伪有界读取.md) |
| BUG-0084 | AI 问答模型未就绪时草稿丢失 | 已修复（前端回归） | P1 | 前端 / AI 问答 / 编辑器 / 模型加载 | [问题-0084-AI问答模型未就绪时草稿丢失.md](问题-0084-AI问答模型未就绪时草稿丢失.md) |
| BUG-0083 | AI 问答置顶会话游标漏页 | 已修复（repository 与前端回归） | P1 | 前后端 / AI 问答 / 会话列表 / 游标 | [问题-0083-AI问答置顶会话游标漏页.md](问题-0083-AI问答置顶会话游标漏页.md) |
| BUG-0082 | AI 问答沉浸页移动端失去系统入口 | 已修复（浏览器验证） | P1 | 前端 / AI 问答 / 移动端 / 导航 | [问题-0082-AI问答沉浸页移动端失去系统入口.md](问题-0082-AI问答沉浸页移动端失去系统入口.md) |
| BUG-0081 | AI 问答旧流误删新流停止句柄 | 已修复（回归验证） | P1 | 后端 / AI 问答 / SSE / 并发 | [问题-0081-AI问答旧流误删新流停止句柄.md](问题-0081-AI问答旧流误删新流停止句柄.md) |
| BUG-0080 | AI 问答 PostgreSQL 跨会话配额竞态 | 已修复（真实 PostgreSQL 并发验证） | P1 | 后端 / AI 问答 / PostgreSQL / 配额 | [问题-0080-AI问答PostgreSQL跨会话配额竞态.md](问题-0080-AI问答PostgreSQL跨会话配额竞态.md) |
| BUG-0079 | AI 问答内部网关 trace 断链 | 已修复（Mock 验证） | P1 | 后端 / AI 问答 / 网关 / trace | [问题-0079-AI问答内部网关trace断链.md](问题-0079-AI问答内部网关trace断链.md) |
| BUG-0078 | AI 问答图片数量与请求体边界失配 | 已修复（HTTP 与前端回归） | P1 | 前后端 / AI 问答 / 图片 / 请求体安全 | [问题-0078-AI问答图片数量与请求体边界失配.md](问题-0078-AI问答图片数量与请求体边界失配.md) |
| BUG-0077 | AI 问答会话切换被旧响应覆盖 | 已修复（回归验证） | P1 | 前端 / AI 问答 / 异步竞态 | [问题-0077-AI问答会话切换被旧响应覆盖.md](问题-0077-AI问答会话切换被旧响应覆盖.md) |
| BUG-0076 | AI 问答 Responses 截断流误记完成 | 已修复（回归验证） | P1 | 后端 / AI 问答 / Responses / SSE | [问题-0076-AI问答Responses截断流误记完成.md](问题-0076-AI问答Responses截断流误记完成.md) |
| BUG-0075 | AI 问答 PostgreSQL 消息游标越界 | 已修复（PostgreSQL 回归） | P1 | 后端 / AI 问答 / PostgreSQL / 游标分页 | [问题-0075-AI问答PostgreSQL消息游标越界.md](问题-0075-AI问答PostgreSQL消息游标越界.md) |
| BUG-0074 | AI 问答初始化失败遗留活动轮次 | 已修复（回归验证） | P1 | 后端 / AI 问答 / 事务 / SSE | [问题-0074-AI问答初始化失败遗留活动轮次.md](问题-0074-AI问答初始化失败遗留活动轮次.md) |
| BUG-0073 | AI 问答复制只依赖 Clipboard API | 已修复（开发验证） | P2 | 前端 / AI 问答 / 剪贴板 | [问题-0073-AI问答复制只依赖ClipboardAPI.md](问题-0073-AI问答复制只依赖ClipboardAPI.md) |
| BUG-0072 | AI 问答编辑原文未显示 | 已修复（真实模型验证） | P1 | 前端 / AI 问答 / Tiptap / UndoRedo | [问题-0072-AI问答编辑原文未显示.md](问题-0072-AI问答编辑原文未显示.md) |
| BUG-0071 | AI 问答协议能力候选误判 | 已修复（Mock 与浏览器验证） | P1 | 后端 / AI 问答 / 网关 / 协议能力 | [问题-0071-AI问答协议能力候选误判.md](问题-0071-AI问答协议能力候选误判.md) |
| BUG-0070 | AI 问答原生图片绕过 HTTPS 限制 | 已修复（开发验证） | P2 | 前端 / AI 问答 / Markdown / 安全 | [问题-0070-AI问答原生图片绕过HTTPS限制.md](问题-0070-AI问答原生图片绕过HTTPS限制.md) |
