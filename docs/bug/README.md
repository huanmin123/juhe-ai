...
| BUG-0075 | 余额快照清理失败后旧值回显 | 已修复（待生产验证） | P1 | 后端 / AI 账户 / 多 Key / 余额快照 / stats-writer | [问题-0075-余额快照清理失败后旧值回显.md](问题-0075-余额快照清理失败后旧值回显.md) |
...
| BUG-0073 | 多 Key 账户被余额查询阻断 | 已修复（待生产验证） | P1 | 前端 / 后端 / AI 账户 / 多 Key / 余额查询 | [问题-0073-多Key账户被余额查询阻断.md](问题-0073-多Key账户被余额查询阻断.md) |
| BUG-0072 | 网关客户端时延与审计主线程阻塞 | 已修复（待生产验证） | P1 | 后端 / 网关 / 原始审计 / 使用记录 / 部署 | [问题-0072-网关客户端时延与审计主线程阻塞.md](问题-0072-网关客户端时延与审计主线程阻塞.md) |
