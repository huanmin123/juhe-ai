...
- 总计划：`docs/plans/计划-20260718T230201008Z-生产管理端性能优先治理.md`
- PostgreSQL 子计划：`docs/plans/计划-20260718T230201009Z-PostgreSQL去事务与统计降载.md`
- Redis / worker 子计划：`docs/plans/计划-20260718T230201010Z-Redis队列隔离与后台任务降载.md`
- 管理接口子计划：`docs/plans/计划-20260718T230201011Z-管理接口渐进加载与事件循环治理.md`
- 历史管理读写隔离：`docs/plans/计划-20260704T095333000Z-管理接口读写隔离与前台防阻塞.md`
- 历史 DTO 分层：`docs/plans/计划-20260704T095333001Z-管理接口DTO分层与渐进式加载.md`
- 历史统计隔离：`docs/plans/计划-20260705T092619000Z-可靠统计与读写资源隔离.md`
