...
- 覆盖系统账户、团队、授权、代理、请求错误策略、AI 账户、分组、API Key、公告、使用记录、模型检测、审计日志、操作日志、运行日志、公开接口日志、外部来源系统、流式拦截策略、IP 统计与封禁策略、后台记录清理目标、账号质量、用量统计、系统监控和表空间监控。
...
- admin 拥有核心业务资源：AI 账户、分组、代理、请求错误策略、团队、授权、公告和主要 API Key。
