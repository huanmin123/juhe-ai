...
- AI 账户普通路由短窗口热质量、故障单飞、精准切号、墙钟 handoff、受控半开和路由观测统一参考 [AI 账户短窗口热质量与精准切号设计](AI账户短窗口热质量与精准切号设计.md)，实施与验证证据参考 [PLAN-0158-20260722T160050118Z](../plans/计划-0158-20260722T160050118Z-AI账户热质量与精准切号实施.md)。该专题已完成开发验收；生产部署、生产流量和 Redis 服务端高可用验证仍需独立执行。
