...
- AI 账户普通路由短窗口热质量、故障单飞、精准切号、墙钟 handoff、受控半开和路由观测统一参考 [AI 账户短窗口热质量与精准切号设计](AI账户短窗口热质量与精准切号设计.md)，早期实施记录参考 [PLAN-0158-20260722T160050118Z](../plans/计划-0158-20260722T160050118Z-AI账户热质量与精准切号实施.md)，当前收口与分层验证参考 [PLAN-0176-20260723T160339731Z](../plans/计划-0176-20260723T160339731Z-账户错误作用域与重试选择验证.md)。Mock、隔离 Redis / PostgreSQL 和类型检查仅有此前基线证据；最终 Node 代码、远端同步后的 L0-L3、最小真实账户探针和测试资源清理尚未全部完成，不能标记为最终开发验收通过。
