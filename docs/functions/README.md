...
- [网关与 jobs 全链路轨迹日志设计](网关全链路轨迹日志设计.md)：traceId 统一贯穿审计/日志/响应头，gateway_dispatch_decision 决策日志自含"为什么选它/为什么不选"的逐账户明细，jobsched 逐轮结局 WARN/DEBUG。
...
- [网关与 jobs 全链路轨迹日志设计](网关全链路轨迹日志设计.md)
