...
| Mock 与验证 | Mock AI 回归脚本和真实烟测需要覆盖三套 GLM 档案、Chat JSON/SSE、Messages JSON/SSE、Codex bridge、错误响应、无 usage 流式、错档案 Key、分组硬边界和统计落库。 | 只测保存账户会漏掉网关调度、协议转换、切号、恢复、usage 和统计链路的集成问题。 |
