...
for (const [name, statusCode, body, expected] of [
  ...
  ['额度码subscription_quota_insufficient', 403, '{"error":{"code":"subscription_quota_insufficient"}}', 'cooldown'],
  ['额度码subscription_quota_not_configured', 403, '{"error":{"code":"subscription_quota_not_configured"}}', 'cooldown'],
  ['额度类型subscription_quota_insufficient', 403, '{"error":{"type":"subscription_quota_insufficient"}}', 'cooldown'],
  ['额度码与权限类型并存', 403, '{"error":{"code":"subscription_quota_insufficient","type":"permission_denied"}}', 'cooldown'],
  ['402额度码subscription_quota_insufficient', 402, '{"error":{"code":"subscription_quota_insufficient"}}', 'cooldown'],
  ['额度码default_group_global_quota_exhausted', 403, '{"error":{"code":"default_group_global_quota_exhausted"}}', 'cooldown'],
  ['额度码billing_hard_limit_reached', 403, '{"error":{"code":"billing_hard_limit_reached"}}', 'cooldown'],
  ...
  ['纯文本subscription quota insufficient403', 403, 'subscription quota insufficient, need=36147', 'cooldown'],
